...
description: Creates new skills or modifies existing ones for the Antigravity agent. Use when the user asks to create a skill or modify skill definitions.
---
